...
This blog uses a **4-section architecture** aligned with the author's identity as **AI Builder, Open Source Contributor, and Digital Nomad**. (The old `categories` taxonomy was retired in v3.0.0 — sections are the primary classification.)
...
| **Growth** (`/growth/`) | Personal growth, annual reviews, mindset, efficiency methods | Annual reviews, monthly thoughts, GTD, Flow State, career development |
| **Projects** (`/projects/`) | AI open source project deep-dives and product builds | LangChain, GPT-Researcher, Jina analysis, independent developer products |

Travel content lives on a standalone page at `/travel/`. Curated multi-part essay series live under `/columns/`.

For detailed architecture documentation, see [`content/CATEGORIES.md`](content/CATEGORIES.md).
...
- **Section (1 per post)**: The directory decides the primary classification (ai-agent / engineering / growth / projects)
...
- [In-depth understanding of the components of Kubernetes Kube apisserver](https://cubxxw.com/engineering/posts/deep-dive-into-the-components-of-kubernetes-kube-apiserver/)
...
- [Participating in This Project](https://cubxxw.com/engineering/posts/participating-in-this-project/)
- [Kubernetes an Article to Get Started Quickly](https://cubxxw.com/engineering/posts/kubernetes-an-article-to-get-started-quickly/)
...
- [深入了解Kubernetes Kube apisserver的组件](https://cubxxw.com/zh/engineering/posts/deep-dive-into-the-components-of-kubernetes-kube-apiserver/)
...
- [Kubernetes一篇快速入门的文章](https://cubxxw.com/zh/engineering/posts/kubernetes-an-article-to-get-started-quickly/)
- [参与我们的区块链学习平台项目](https://cubxxw.com/zh/engineering/posts/participating-in-this-project/)
