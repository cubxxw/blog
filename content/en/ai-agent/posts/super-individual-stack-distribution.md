...
[The overview](../super-individual-stack-four-layers/) said the four layers have a direction: the output of layer four should settle downward into assets for layers two and one. At the distribution layer, that pipeline looks like this:
