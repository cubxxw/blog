...
<p>![](https://sm.cubxxw.com/sm202310142043549.png)</p>
<p><strong>More detailed request processing process:</strong></p>
<p>![](https://sm.cubxxw.com/sm202310142043692.jpeg) </p>
...
![Figure 2 Two-way TLS process](https://sm.cubxxw.com/sm202303051505019.webp)
...
+ 2) At the same time, since `apiserver` is run in a container, you need to add `mount` to `hostpath` and mount the directory where `static token` is stored into the container.
   ...
   ![image-20230305162319477](https://sm.cubxxw.com/sm202303051623527.png)

   ![image-20230305162510114](https://sm.cubxxw.com/sm202303051625169.png)
...
![image-20230305171723601](https://sm.cubxxw.com/sm202303051717736.png)
...
![img](https://sm.cubxxw.com/sm202303051947235.png)
