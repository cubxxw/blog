...
![Figure 2 Two-way TLS process](https://sm.nsddd.top/sm202303051505019.webp)
...
+ 2) At the same time, since `apiserver` is run in a container, you need to add `mount` to `hostpath` and mount the directory where `static token` is stored into the container.
   ...
   ![image-20230305162319477](https://sm.nsddd.top/sm202303051623527.png)

   ![image-20230305162510114](https://sm.nsddd.top/sm202303051625169.png)
...
![image-20230305171723601](https://sm.nsddd.top/sm202303051717736.png)
...
![img](https://sm.nsddd.top/sm202303051947235.png)
