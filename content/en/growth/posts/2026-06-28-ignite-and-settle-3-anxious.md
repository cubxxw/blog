...
type: posts
author: ["Xinwei Xiong"]
keywords: ["anxious attachment", "attachment theory", "intimacy", "anxious-avoidant trap", "Chinese family", "emotional inconsistency", "psychology", "safety", "self-repair"]
tags:
  - Psychology
  - Attachment
  - Relationships
...
tldr:
  - The core of anxious attachment is unstable love — love was there, but unpredictable; response was there, but hot then cold.
  - It most easily attracts the avoidant — one wants to come close, one wants to retreat. The more one chases, the more the other flees.
...
> I really need the relationship, but I'm not sure the other person will keep being here.
> So I keep confirming, testing, getting close, worrying about losing them.
...
> I have to perform well to be loved.
> I must be obedient enough, useful enough, mature enough — for the relationship to not break.
...
Avoidant fears engulfment, control, losing self.
Anxious fears abandonment, being neglected, losing the relationship.
...
> Really urgent things: the other person clearly says they're leaving; clearly says they no longer love you; takes an action that harms you.
> Not urgent: a slow reply; a cool day; they're busy; they need space.
...
1. You prove to yourself: **you don't chase and you don't die** — this experience is revolutionary for your own repair.
2. You transmit a new signal to him: **this person doesn't collapse just because I retreat** — which, for an avoidant, may be the first key experience of starting to trust intimacy.
...
> Let them come close.
> Express a need.
> Believe that this time, it won't be the same.
