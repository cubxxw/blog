---
title: 'Ignite and Settle (Part 2): Avoidant Attachment — Why We Want to Run When Someone Gets Close'
...
type: posts
author: ["Xinwei Xiong"]
keywords: ["avoidant attachment", "attachment theory", "intimacy", "Chinese family", "emotional neglect", "childhood", "psychology", "self-repair"]
tags:
  - Psychology
  - Attachment
  - Relationships
...
tldr:
  - Avoidant is not coldness. It is an early-learned lesson — expressing needs doesn't work, getting close isn't safe, carrying it alone is steadiest.
  - The pattern usually forms between ages 0 and 6, with 0 to 3 most critical. It isn't formed on any single day — it's the residue of repeated adaptation.
...
Your reflex is: "Nothing." "I'm fine." "Don't worry about it."
