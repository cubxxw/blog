...
type: posts
author: ["Xinwei Xiong"]
keywords: ['personal growth', 'friction', 'AI dependency', 'deep thinking', 'deliberate practice', 'cognition', 'writing', 'reflection', 'self-discipline', 'growth in the AI era']
tags:
  - Personal Growth
  - Self-Discovery
  - AI
...
tldr:
  ...
  - AI's entire value proposition is removing friction — faster, less effort, painless. That's a good thing in a lot of places, but growth comes almost entirely from friction.
  - Real growth comes with the discomfort of "forcing the vague into the clear" — the difficulty of writing, the pain of not being able to figure something out, the sting of being contradicted. Reflection plus pain equals progress.
  - "The danger isn't using AI — it's outsourcing the friction that should have been kept. The result: an increasingly capable AI, and an increasingly hollow version of yourself."
  - "A new discipline: tell apart which friction should be removed (repetitive, trivial, mindless labor) and which should be deliberately kept (thinking, judgment, expression, decision-making), and deliberately reserve the latter for yourself."
maturity: budding
---
...
**Friction that should be boldly removed** (no growth content, pure consumption):
formatting, information retrieval, translation, deduplication, compressing long material into a summary, initial classification — hand these to AI, the more aggressively the better.

**Friction that should be actively kept** (this is where growth lives):
forcing a vague idea into clear text (writing), forming your own judgment on a question (thinking), deciding direction and trade-offs (decision-making), being jolted by an objection (self-examination). Even if AI could do these for you, you should do them yourself first.
