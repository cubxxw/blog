...
### Service-as-Software：4.6 万亿美元的新单位
...
## 工程支撑：Soul Core + Harness + Overnight Agent

如果产品方向是「做什么」，那这一节是「怎么做」。三个工程概念是超级个体绕不过去的。

### Soul Core：定义「我」的 schema
...
### Harness Engineering：那 98.4% 的脚手架
...
### Lusser's Law 给「为什么 HITL 不能省」立桩
