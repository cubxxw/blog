...
tldr:
  - "GTD核心价值在于通过外脑记忆系统节省脑力，使执行阶段心无旁骛，需要完整收集信息、判断分类、定期复查三环节保证系统有效运转。"
  - "四象限法则的关键是专注第二象限（重要但不紧急），预防潜在危机，从而减少第一象限紧急任务，避免被动应对而陷入恶性循环。"
  - "滴答清单实践GTD需建立收集箱、标签、清单、清单夹、颜色分类等结构，结合GitHub Issue作为项目容器，番茄工作法提升专注，定期回顾维持系统稳定性。"
---
...
![dida-gtd](https://sm.cubxxw.com/20240212223943.png)
