...
探索 AI 与大模型时代的前沿技术，涵盖：

- **AI/LLM 应用** - LLM 应用开发、Agent 框架、LangChain 实战
- **Kubernetes 云原生** - K8s 源码分析、CNI/CSI/CRI、Service Mesh
- **Go 语言工程化** - 跨平台开发、并发编程、工具链建设
- **DevOps 实践** - CI/CD、GitOps、自动化测试、发布工具
