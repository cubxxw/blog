...
tldr:
  ...
  - "有效提示词需结合摄影技术、视觉风格、拍摄技巧、技术效果和情绪表达等元素，包括景深、色彩、特效、光线等具体指令。"
  - "SoraEase项目为开发者提供自动化工具和中文提示词指南，帮助快速上手Sora视频创作，并建立了社群交流平台共享最新资讯。"
---
...
- **加入我们的社群**：添加 Wechat **cubxxw_com** 并回复 `sora` 进群。在我们的微信社群中，你可以获取 Sora 的最新咨询，技术分享，同时也是Sora爱好者和开发者的交流平台。
