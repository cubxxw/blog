...
tldr:
  - "大语言模型通过涌现现象展现出宏观层面的特殊能力，预训练和微调结合已成为模型发展的主流趋势。"
  - "微调技术如Adapter、LoRA、QLoRA能以更低成本实现模型定制化，适应具体业务场景的需求。"
  - "构建领域知识问答系统需融合微调、外挂知识库和生成能力，同时需处理幻觉、召回率等核心挑战。"
---
...
![Untitled](http://sm.cubxxw.com/Untitled (2).png)
...
![Untitled](http://sm.cubxxw.com/Untitled (1).png)
...
[搭建一个FAQ智能问答系统](http://sm.cubxxw.com/Untitled.png)
