...
> **📌 2026-07 更新**：这篇写于 2023 年，记录的是这座博客"第三代"用 Hugo 从零搭起来的过程，搭建教程部分至今有效。三年后，我又把整个博客重新组装了一遍——这次动的不是主题，而是整条生产线：AI 写作流水线、两段式封面工厂、GitHub Actions 里的 AI 值班员、GEO 基建。完整复盘在新文章：[《一个人带一队 Agent，把 120 多篇文章的博客重新组装了一遍》](/zh/ai-agent/posts/ai-native-blog-rebuild/)。建议两篇搭配着读——一篇是地基怎么打，一篇是房子怎么长成系统。
