...
tags: ["Blog", "Go"]
description: '用 Docker buildx 结合 QEMU 交叉编译 arm/arm64/amd64 镜像的实战记录：如何按目标架构调整 Dockerfile 基础镜像和依赖下载地址，复杂构建为什么要上真机验证，附 docker buildx imagetools inspect 检查方法。'
tldr:
